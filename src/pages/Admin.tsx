...
import { getData, addData, updateData, deleteData, Product, Testimonial, Media, PRODUCTION, toggleProduction } from '../lib/data';
import { LayoutDashboard, Package, MessageSquare, Settings, LogOut, Plus, Search, Layers, Image as ImageIcon, Trash2 } from 'lucide-react';
