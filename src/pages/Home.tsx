...
export const Home = () => {
  return (
    <div className="bg-brand-black min-h-screen selection:bg-brand-gold selection:text-brand-black">
      <Head
        title="Maheshwari Attar — Handcrafted Attars from Kannauj"
        description="Discover Maheshwari Attar — handcrafted Indian attars using traditional distillation techniques. Explore our curated collection."
      />
