...
export const About = () => {
  return (
    <div className="bg-brand-black min-h-screen pt-32 pb-20">
      <Head
        title="About — Maheshwari Attar"
        description="Learn about Maheshwari Attar's legacy, traditional distillation methods, and four generations of perfumers from Kannauj."
      />
