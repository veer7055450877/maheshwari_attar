...
{/**const products = [
  {
    ...
    image: "https://assets.myntassets.com/w_360,q_50,,dpr_2,fl_progressive,f_webp/assets/images/2025/NOVEMBER/10/RXh16shO_541c29e0289e47878dae300ef6a5bd6d.jpg",
  },
  {
    id: 2,
    name: "Midnight Rose",
    tagline: "Dark Floral Mystery",
    image: "https://images.unsplash.com/photo-1547887538-e3a2f32cb1cc?q=80&w=2574&auto=format&fit=crop",
  },
  {
    id: 3,
    name: "Golden Amber",
    tagline: "Warmth of the Desert",
    image: "https://images.unsplash.com/photo-1615634260167-c8cdede054de?q=80&w=2574&auto=format&fit=crop",
  }
 */}
const products: Product[] = await getData('products') as Product[];
export const Collection = () => {
  return (
    <section id="collection" className="bg-brand-black">
      {/* Vertical Poster Walk */}
      {products.map((product, index) => (
        <div key={product.id} className="relative h-screen w-full flex items-center justify-center overflow-hidden sticky top-0">
          ...
          <div className="relative z-10 container mx-auto px-6 h-full flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
            ...
            >
              ...
              <button className="text-[10px] uppercase tracking-[0.3em] text-brand-ivory border-b border-white/20 pb-2 hover:text-brand-gold hover:border-brand-gold transition-all duration-500">
                View Frame
              </button>
            </motion.div>
